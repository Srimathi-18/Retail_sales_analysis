...
This project is designed to demonstrate SQL skills and techniques typically used by data analysts to explore, clean, and analyze the retail sales data. This project involves setting up a retail sales database, performing exploratory data analysis (EDA), and answering specific business questions through SQL queries.
...
7. **Write a SQL query to calculate the avg sale of each month . find out best selling month in each year.**:
```sql
